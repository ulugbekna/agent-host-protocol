/**
 * Canvas Channel Commands — `listCanvasTypes`, `openCanvas`,
 * `resolveCanvasSource`, `invokeCanvasAction`, `restartCanvasProvider`, and
 * `closeCanvas`.
 *
...
import type {
  ...
  CanvasEntry,
  CanvasIdentityKey,
  CanvasSourcePresentation,
  CanvasTypeDeclaration,
} from './state.js';
